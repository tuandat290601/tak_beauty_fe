          ...
          <div class="container">
            ...
            <div class="breadcrumb-wrap">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{product && <span>{product.category.title}</span>}</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-12 col-md-5">
                {
                  product.image && <Slider
                    {...setting}
                  >
                    {product.image.map((img, index) => <div className="slide-container">
              ...
              <div className="col-12 col-md-7 ps-3">
                ...
                <div className="row my-4">
                  <div className="col-6"><strong>Mã sản phẩm:</strong>  {product.sku}</div>
                  <div className="col-6"><strong>Xuất xứ:</strong></div>
                  <div className="col-6"><strong>Loại sản phẩm:</strong></div>
                  <div className="col-6"><strong>Loại:</strong></div>
                </div>
                <hr style={{ width: "100%" }} />
                <div className="row my-4">
                  ...
                  <div className="col-12 col-xl-4 d-flex align-items-center justify-content-end">
                    <StarRatingComponent
                      ...
                      name="rating" />
                    <span className="ms-1">({product.connects.filter(connect => connect.feedbackId !== null).length} đánh giá)</span>
                  </div>
                </div>
                <hr />
                <div className="row my-4">
                  <div class="main-product-quantity shop-quantity-wrap">
                    ...
                    <div class="shop-quantity">
                      <button type="button" data-type="shop-quantity-minus" title="Giảm" onClick={() => setQuantity((old) => {
                        return old === 1 ? old : old - 1
                      })}>-</button>
                      <input type="number" name="quantity" value={quantity} min="1" readonly="" />
                      <button type="button" data-type="shop-quantity-plus" title="Tăng" onClick={() => setQuantity((old) => old + 1)}>+</button>
                    </div>
                  </div>
                </div>
                <div className="row mt-4">
                  <div className="col-6"><button className="btn custom-btn add-cart-btn">Thêm vào giỏ</button></div>
                  <div className="col-6"><Link to="/" target="_blank" className="btn custom-btn add-cart-btn">Tư vấn ngay</Link></div>
                </div>
              </div>
            </div>
            <div className="row">
