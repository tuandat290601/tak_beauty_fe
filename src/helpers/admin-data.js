export const adminNavbar = [
  ...
  {
    imgSrc:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUJYtyWD3Tsynm-BWm7q48awFblLkw5mHpeb1zqgTSgQ&s",
    name: "Chức năng",
    subMenu: [
      ...
      { name: "Quản lý banner", path: "/admin/banner/banner-management" },
    ],
  },
  // {
  //   imgSrc:
